...
public class Leds extends VirtualSubsystem {
  ...
  // Constants
  private static final boolean saintechColors = false;
  ...
  private Leds() {
    ...
    loadingNotifier.startPeriodic(0.09);
  }
  ...
  public synchronized void periodic() {
    ...
    // Update estop state, astop isnt availble at the time
    ...
    if (estopped) {
      ...
      } else if (saintechColors) {
        // Saintech stripes
        stripes(
            Section.FULL, List.of(Color.kBlack, Color.kRed, Color.kYellow, Color.kWhite), 3, 5.0);
        switch (alliance) {
          case Red:
      ...
      if (climb) {
        solid(Section.SHOULDER, Color.kPink);
